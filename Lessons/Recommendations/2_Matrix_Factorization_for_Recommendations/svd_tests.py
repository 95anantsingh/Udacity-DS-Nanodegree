def test1(sol_1_dict):
    ...
    if sol_1_dict['the number of users in the user_movie_subset'] != sol_1_dict_sol[
        'the number of users in the user_movie_subset']:
        print(
            "That doesn't look right for the number of users.  Notice, this should be the number of rows in the subset dataframe.")

    if sol_1_dict['the number of movies in the user_movie_subset'] != sol_1_dict_sol[
        'the number of movies in the user_movie_subset']:
        print(
            "That doesn't look right for the number of movies.  Notice, this should be the number of columns in the subset dataframe.")

    if sol_1_dict['the user_id with the highest average ratings given'] != sol_1_dict_sol[
        'the user_id with the highest average ratings given']:
        print("That doesn't look right for the user with the highest average rating given.  Try again.")

    if sol_1_dict['the movie_id with the highest average ratings received'] != sol_1_dict_sol[
        'the movie_id with the highest average ratings received']:
        print("That doesn't look right for the movie_id with the highest average received.  Try again.")

    if sol_1_dict['the name of the movie that received the highest average rating'] != sol_1_dict_sol[
        'the name of the movie that received the highest average rating']:
        print(
            "Oops!  The last one should be the name of the movie - not just the id.  You can get this from the movies dataframe.  Try again.")
...
def test2(sol_2_dict):
    ...
    if sol_2_dict['the number of columns in the U matrix'] != sol_2_dict_sol['the number of columns in the U matrix']:
        print(
            "Oops!  The number of columns in the U matrix will be determined by the number of latent features you decide to keep.  This will at most be the minimum of the number of users and number of movies (in our case the minimum is the 4 movies).  Try again.")

    if sol_2_dict['the number of rows in the V transpose matrix'] != sol_2_dict_sol[
        'the number of rows in the V transpose matrix']:
        print(
            "Oops!  The number of rows in the V transpose matrix will be determined by the number of latent features you decide to keep.  This will at most be the minimum of the number of users and number of movies (in our case the minimum is the 4 movies).  Try again.")

    if sol_2_dict['the number of columns in the V transpose matrix'] != sol_2_dict_sol[
        'the number of columns in the V transpose matrix']:
        print(
            "Oops!  The number of columns in the V transpose matrix will be determined by the number of movies. Try again.")
