...
def q4_piat_check(q4_piat):
    ...
    elif q4_piat['The optimal number of features based on the results is'] != q4_piat_1[
    ...
    elif q4_piat['The model we should implement in practice has a train rsquared of'] != q4_piat_1[
    ...
    elif q4_piat['If we were to allow the number of features to continue to increase'] != q4_piat_1[
