...
def scatter_check(scatter_sol):
    ...
    if scatter_sol['Data in the ______ column meant missing data in three other columns'] != s.scatter_sol[
        'Data in the ______ column meant missing data in three other columns']:
        print(
